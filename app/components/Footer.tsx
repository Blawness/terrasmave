          ...
          <FadeIn direction="up">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-6">
                Es krim sandwich homemade berbahan organik, dibuat dengan cinta dari dapur kami untuk keluarga
                Indonesia.
              </p>
          ...
          <FadeIn direction="up" delay={0.3}>
            <div>
              ...
              <p className="text-white/70 text-sm mb-4">
                Subscribe untuk update varian baru dan promo eksklusif. Dapatkan diskon 10% untuk
                pesanan pertama!
              </p>
              <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
                <input
                  ...
                  className="flex-1 bg-white/10 border border-white/20 rounded-md px-3 py-2 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-white/50"
                />
                <button
                  type="submit"
                  className="bg-white text-primary font-semibold px-4 py-2 rounded-md hover:bg-stone-100 transition-colors"
                >
                  →
                </button>
              </form>
        ...
        <FadeIn delay={0.4}>
          <div className="border-t border-white/20 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-white/50 text-xs">
              &copy; 2025 Terrasmave. All rights reserved.
            </p>
